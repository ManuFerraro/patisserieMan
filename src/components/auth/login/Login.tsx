  ...
  return (
    <>
      ...
      <main className="fixed top-0 right-0 bg-white w-full lg:w-[650px] h-full z-100">
        <div className="w-full h-[5px] xxs:h-[40px] lg:h-[68px] xl:h-[54px] 2xl:h-[68px] flex justify-end items-start xxs:items-center lg:items-center pr-5 lg:pr-10 cursor-pointer">
          x
        </div>
        <form className="w-[85%] lg:w-[62%] h-full mx-auto flex flex-col">
          ...
          <div className="flex flex-col sm:justify-center sm:items-center">
            <div className="h-[86px] sm:h-[92px] flex flex-col justify-around ">
              <p
                className={` text-[14px] font-nutitoSans font-bold text-formName`}
              >
                Email*
              </p>
              <input
            ...
            <div className="h-[86px] sm:h-[92px] flex flex-col justify-around">
              ...
              <div className="relative">
                ...
                {
                  showPassword ? 
                <div className="absolute inset-y-0 right-3 flex items-center pr-2" onClick={() => setShowPassword(!showPassword)}>
                  <PiEyeSlashThin className="w-5 h-5 text-black cursor-pointer " />
                </div>
                :
                <div className="absolute inset-y-0 right-3 flex items-center pr-2" onClick={() => setShowPassword(!showPassword)}>
          ...
          <div className="w-full flex justify-center lg:justify-end items-center">
            <p className="font-nunitoSans text-sm pt-1 text-formName font-semibold">
          ...
          <div className="w-full h-[250px]  sm:h-[260px] xl:h-[160px] 2xl:h-[260px] flex flex-col sm:justify-center items-center xl:justify-start 2xl:justify-center">
            <p className="font-nunitoSans text-[15px] font-semibold text-black  p-5">
              NO TIENES CUENTA TODAVÍA?
            </p>
            <button className="w-[120px] sm:w-[180px] h-[50px] bg-buttonLogin text-black border border-black">
              REGISTRATE
            </button>
          </div>
        </form>
